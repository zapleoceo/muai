...
#: Украинские І Ї Є Ґ лежат вне диапазона А-Я — без них «Клига Ігор» 22.09
#: не опознавался, и личный звонок остался без имени.
_UPPER = "A-ZА-ЯЁІЇЄҐ"
_PERSON = re.compile(
    rf"^[{_UPPER}][\w'’-]+(?:\s+[{_UPPER}][\w'’-]+){{1,2}}$", re.UNICODE)
