"""Что отправлять на распознавание (vision/whisper).

Гейт rel-extract (каналы, группы без участия) переехал в
`vera_shared.graph.rel_policy` вместе с остальными признаками.
