...
сформировать args. Args должны быть согласованы с метаданными события
(thread_id, email, peer и т.д. — бери из event).

Если по инструкции инструмент не нужен (например, «забей», «ничего»),
