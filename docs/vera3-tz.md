> ⚠️ **ИСТОРИЧЕСКИЙ ДОКУМЕНТ — не руководство к действию.**
> Это черновик ТЗ от 2026-06-08, написанный ДО реализации. Система с тех пор
> ушла в сторону: нет ни Neo4j, ни Graphiti, ни Cognee, ни LiteLLM на стороне
> Веры (все LLM-вызовы идут через внешний AIbroker), хранилище — Postgres +
> pgvector без SQLite. Что живёт на самом деле: [`/VERA.md`](../VERA.md) и
> [`vera3/docs/`](../vera3/docs/). Документ оставлен как след замысла и
> обоснования решений.
